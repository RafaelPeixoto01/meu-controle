...
- CR-051: Follow-ups do CR-050 — `formatDateBRWithYear` corrige vencimento exibido um dia antes na tabela de parcelas (parse UTC de data sem hora); progresso/restantes de parcelamento centralizados em `services.calcular_progresso_parcelamento()`/`calcular_parcelas_restantes()` e adotados pelo health_score, onde compra cadastrada do meio era tratada como "nao iniciada"; 9 testes novos (concluido)
